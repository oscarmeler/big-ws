...
Christian García Artero | 597578 | [repo](https://github.com/christianjaka94/big-ws) | [![Build Status](https://travis-ci.org/christianjaka94/big-ws.svg?branch=master)](https://travis-ci.org/christianjaka94/big-ws) | Not changed, only learned, and learning is not to change is to grow |No cambié, sólo aprendí, y aprender no es cambiar es crecer
